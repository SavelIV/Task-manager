        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="features_items">
                    <h4>Список задач (панель администратора)</h4>
                    <br/>
                    <table class="table-bordered table-striped table">
                        <tr>
                            <th><a href="/cabinet/order-id/page-1"><i class="fa fa-sort"></i>ID задачи</a></th>
                            <th><a href="/cabinet/order-name/page-1"><i class="fa fa-sort"></i>Имя</a></th>
                            <th><a href="/cabinet/order-email/page-1"><i class="fa fa-sort"></i>Email</a></th>
                            <th>Описание</th>
                            <th><a href="/cabinet/order-status/page-1"><i class="fa fa-sort"></i>Статус</a></th>
                            <th>Категория</th>
                            <th>Редактировать</th>
                        </tr>
