        ...
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4 padding-right">
                <?php if ($result): ?>
                    ...
                    <meta http-equiv="refresh" content="4, url='/cabinet/order-id/page-1'">
                    <p class="success">Если этого не произошло, кликните сюда:</p>
                    <?php if ($result): ?>
                        <a href="/cabinet/order-id/page-1" class="btn btn-default"><i class="fa fa-user"></i> Домой</a>
                    <?php endif; ?>
                <?php else: ?>
                    ...
                    <div class="signup-form"><!--sign up form-->
                        ...
                        <form action="#" method="post">
                            <p>Имя (только буквы и пробелы):</p><input type="text" name="name" placeholder="Name" value="<?php echo $name; ?>"/>
